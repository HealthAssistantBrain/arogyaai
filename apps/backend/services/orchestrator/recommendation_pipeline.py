...
from services.recommendation_engine import generate_fast_recommendation_plan, generate_fast_recommendation_plans
...
class RecommendationPipeline:
    def generate_plan(self, user_id: str, *, db: Session) -> dict[str, Any]:
        return generate_fast_recommendation_plan(user_id, db=db)

    def generate_plans(self, user_id: str, *, db: Session) -> list[dict[str, Any]]:
        return generate_fast_recommendation_plans(user_id, db=db)
