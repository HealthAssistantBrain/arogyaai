...
class Settings(BaseSettings):
    ...
    SUPABASE_JWKS_REFRESH_COOLDOWN_SECONDS: float = float(os.getenv("SUPABASE_JWKS_REFRESH_COOLDOWN_SECONDS", "30.0"))
    SUPABASE_JWKS_FAILURE_COOLDOWN_SECONDS: float = float(os.getenv("SUPABASE_JWKS_FAILURE_COOLDOWN_SECONDS", "15.0"))
