  ...
  return (
    <div className="bg-[#EAEAEA] dark:bg-[#131022] text-[#13082A] dark:text-slate-100 min-h-screen font-display antialiased leading-normal">
      <div className="flex h-screen overflow-hidden">
        ...
        <aside className="w-64 bg-white/80 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between py-6 px-4 shrink-0 hidden md:flex backdrop-blur-md z-40">
          <div className="space-y-8">
            <Link to={ROUTES.LANDING} className="flex items-center gap-3 px-2">
              <div className="size-10 rounded-xl bg-gradient-to-br from-[#6043F4] to-[#009CDE] flex items-center justify-center text-white shadow-lg">
                <ClipboardList size={24} strokeWidth={2.5} />
              </div>
              <div>
                <h1 className="font-bold text-lg tracking-tight">ArogyaAI</h1>
                <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold leading-none mt-1">Intelligence</p>
              </div>
            </Link>
              ...
              {sidebarLinks.map((link) => (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 group ${
                    ...
                    ? 'bg-[#6043F4]/10 text-[#6043F4] font-bold' 
                    : 'text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 font-medium'
                  }`}
                >
                  <link.icon size={20} className={activeTab === link.label ? 'text-[#6043F4]' : 'text-slate-400'} />
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-gradient-to-br from-[#6043F4]/5 to-[#009CDE]/5 border border-[#6043F4]/10">
              <p className="text-xs font-bold text-[#6043F4] uppercase mb-2 leading-none tracking-widest">Cloud Sync</p>
              <div className="flex items-center gap-2">
                <div className="size-2 rounded-full bg-green-500 animate-pulse"></div>
                <span className="text-sm font-semibold">Systems Active</span>
              </div>
            </div>
            
            <Link 
              to={ROUTES.SETTINGS}
              className="flex items-center gap-3 px-4 py-3 rounded-lg text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all font-medium"
            >
              <Settings size={20} />
              <span>Settings</span>
            </Link>
