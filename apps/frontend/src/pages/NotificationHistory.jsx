                ...
                <aside className="w-72 bg-white dark:bg-[#131022] border-r border-[#6143f4]/5 dark:border-white/5 flex flex-col h-full overflow-y-auto no-scrollbar hidden lg:flex shrink-0">
                    <div className="p-8 flex items-center gap-4 cursor-pointer group" onClick={() => navigate(ROUTES.DASHBOARD)}>
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] mt-1">Predictive Health</p>
                        </div>
                    </div>
                    
                    <nav className="flex-1 px-5 space-y-1.5 overflow-y-auto pb-6 custom-scrollbar">
                        <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.25em] px-4 mb-3 mt-4 leading-none uppercase">Navigation</div>
                        {sidebarLinks.map((link) => (
                            ...
                            >
                                ...
                                {link.label === 'Notifications' && !link.active && (
                                    <span className="ml-auto bg-[#6143f4] text-white text-[9px] px-1.5 py-0.5 rounded-full font-black">12</span>
                                )}
                            </button>
                        ))}
                    </nav>
                    ...
                    <div className="p-6 border-t border-slate-100 dark:border-white/5">
                        <div className="flex items-center gap-3 p-3 rounded-[1.5rem] bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 hover:border-[#6143f4]/30 transition-colors cursor-pointer group">
                             <div className="size-11 rounded-xl bg-[#6143f4]/10 overflow-hidden border-2 border-transparent group-hover:border-[#6143f4] transition-all">
                                 <img className="size-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCmca7uoDE5AXEl5Lm8J0kNozFbXew2KmxjvbMH9Uxz6_puV-3M4e6vnlXT3lEb_5cr82WJlJpIhLxX0n3slwWbP57cryd-X1PYojJGyEJFIbxEi5GoRB7BAanTNFGumWZcuLVazL6mqrjhuvUC3gGRtjHZVA9j0pjweqT5KOzZfnYTmtLSNDWzJTJ0I2GNWutesIDE2flIJl8eYqrE_zQxMiy9H-ayg4LdE001a6UkDGckUUtZ533LriYErfK1okd7WRmFj5K6lXvB" alt="Sarah Johnson" />
                             </div>
                             <div className="flex-1 min-w-0">
                                 <p className="text-xs font-black truncate text-[#13082a] dark:text-white uppercase leading-none">Sarah Johnson</p>
