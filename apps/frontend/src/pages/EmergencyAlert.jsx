      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <div className="absolute inset-0 z-0 flex blur-[4px] opacity-40 pointer-events-none select-none">
            ...
            <div className="flex-1 flex flex-col h-full bg-background dark:bg-background">
                ...
                <div className="flex-1 p-10">
                    <div className="h-full w-full bg-surface rounded-[2.5rem]"></div>
                </div>
            </div>
        </div>

        {/* Modal Overlay / Backdrop */}
        <div className="absolute inset-0 z-10 bg-card/60 backdrop-blur-md pointer-events-none"></div>
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center p-6 md:p-12 lg:p-16">
            <motion.div 
                ...
                className="bg-surface rounded-[2.5rem] shadow-[0_50px_100px_-20px_rgba(239,68,68,0.3)] w-full max-w-6xl overflow-hidden border border-white dark:border-stroke/50 pointer-events-auto"
            >
                ...
                <div className="bg-red-500 p-6 flex items-center justify-between px-10 relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 text-text-primary relative z-10">
                    ...
                    <div className="bg-white/20 px-5 py-2 rounded-full text-text-primary text-[10px] font-black tracking-widest backdrop-blur-md border border-white/30 uppercase italic flex items-center gap-2 relative z-10">
                ...
                <div className="p-10 lg:p-16 flex flex-col xl:flex-row gap-16">
                    ...
                    <div className="flex-1 space-y-12">
                        <div className="space-y-6">
                            ...
                            <h1 className="text-5xl lg:text-7xl font-black text-text-primary dark:text-text-primary uppercase tracking-tighter italic leading-[0.85] mb-4">
                                Critical Cardiac <br/> Anomaly Detected
                            </h1>
                            <p className="text-xl text-slate-500 dark:text-text-muted font-bold uppercase tracking-tight leading-relaxed max-w-2xl italic opacity-80">
                        ...
                        <div className="bg-slate-50 dark:bg-white/5 rounded-[3rem] p-10 border border-slate-100 dark:border-stroke/50 shadow-inner group transition-all hover:bg-white dark:hover:bg-white/10 duration-500">
                            <div className="flex items-center justify-between mb-10">
                                <div className="space-y-1">
                                    <span className="text-[11px] font-black text-text-muted uppercase tracking-[0.4em]">Real-time Monitoring</span>
                                    <h4 className="text-sm font-black text-text-primary dark:text-text-primary uppercase tracking-widest italic leading-none">Vocal Heart Rate Stream</h4>
                                </div>
                                <div className="flex gap-4">
                                    ...
                                    <span className="text-[10px] text-primary bg-primary/10 px-4 py-2 rounded-xl font-black uppercase tracking-widest border border-primary/10 shadow-sm italic">Alex Sterling</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-baseline gap-6 mb-8 group-hover:scale-105 transition-transform duration-700 origin-left">
                                ...
                                <span className="text-3xl font-black text-text-muted uppercase tracking-[0.2em] italic">BPM / V-FLOW</span>
                            </div>

                            {/* Dynamic ECG Waveform */}
                            <div className="mt-10 h-40 w-full relative overflow-hidden rounded-[2rem] bg-card flex items-center shadow-3xl border border-stroke/50 border-t-red-500/30">
                                <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: 'linear-gradient(90deg, var(--color-primary) 1px, transparent 1px), linear-gradient(var(--color-primary) 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
                                ...
                                <div className="absolute top-4 right-6 flex items-center gap-2">
                                    ...
                                    <span className="text-[9px] font-black text-text-primary/50 uppercase tracking-[0.3em]">Synched to Wearable</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full xl:w-[480px] flex flex-col gap-10 shrink-0">
                        {/* Protocol Checklist */}
                        <div className="bg-slate-50 dark:bg-white/5 p-10 rounded-[3rem] border border-slate-100 dark:border-stroke/50 shadow-inner flex-1 space-y-10 group/proto transition-all hover:bg-white dark:hover:bg-white/10 duration-500">
                            <div className="flex items-center gap-5">
                                <div className="size-14 rounded-2xl bg-primary/15 flex items-center justify-center text-primary shrink-0 shadow-inner group-hover/proto:rotate-12 transition-transform duration-500">
                                    <ClipboardCheck size={32} strokeWidth={2.5} />
                                </div>
                                <h3 className="text-2xl font-black text-text-primary dark:text-text-primary uppercase tracking-tighter italic leading-none">Emergency Protocol</h3>
                            </div>
                            
                            <div className="space-y-6">
                                {[
                                    { icon: Armchair, color: 'text-primary', bg: 'bg-primary/15', text: 'Sit down and rest immediately. Do not attempt to stand up.' },
                                    { icon: Wind, color: 'text-secondary', bg: 'bg-secondary/15', text: 'Take deep, slow breaths. Focus on prolonged exhalations.' },
                                    { icon: ShieldAlert, color: 'text-red-500', bg: 'bg-red-500/15', text: 'Avoid any physical exertion until cleared by a medic.' },
                                ].map((step, idx) => (
                                    <div key={idx} className="flex items-start gap-6 p-6 bg-surface rounded-[2rem] border border-slate-100 dark:border-stroke/50 shadow-sm hover:scale-[1.03] transition-all duration-300">
                                        ...
                                        <div className="pt-1 space-y-1">
                                            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-text-primary/30 dark:text-text-primary/30">Step {idx + 1}</span>
                                            <p className="text-[12px] font-black uppercase tracking-widest leading-relaxed text-text-primary dark:text-text-secondary italic opacity-90">{step.text}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="space-y-5">
                            <button 
                                ...
                                className="group w-full py-6 bg-primary text-white rounded-[2rem] font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-5 shadow-2xl shadow-primary/40 hover:scale-[1.02] active:scale-95 transition-all outline-none italic"
                            >
                                <HelpCircle size={22} className="group-hover:rotate-12 transition-transform" />
                                Open Support Center
                            </button>
                            <button 
                                className="group w-full py-6 bg-red-500 text-text-primary rounded-[2rem] font-black text-[11px] uppercase tracking-[0.3em] flex items-center justify-center gap-5 shadow-2xl shadow-red-500/40 hover:scale-[1.02] active:scale-95 transition-all outline-none italic"
                            >
                            ...
                            <button 
                                onClick={() => navigate(ROUTES.HELP)}
                                className="w-full text-center pt-2 group flex items-center justify-center gap-3 transition-colors text-text-muted hover:text-primary"
                            >
                ...
                <div className="bg-slate-50/50 dark:bg-white/[0.02] px-10 py-6 border-t border-slate-100 dark:border-stroke/50 grid grid-cols-1 md:grid-cols-3 gap-8 text-[9px] font-black uppercase tracking-[0.2em] text-text-muted italic">
