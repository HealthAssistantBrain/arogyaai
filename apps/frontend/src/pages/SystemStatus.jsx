        ...
        <header className="bg-white/80 dark:bg-[#13082A]/80 backdrop-blur-2xl border-b border-slate-200 dark:border-white/5 h-24 px-10 flex items-center justify-between shrink-0 sticky top-0 z-50">
          ...
          <div className="flex items-center gap-8 pl-10">
            <div className="flex items-center gap-3">
              ...
              <button className="p-3.5 text-slate-500 hover:bg-[#6143f4]/10 hover:text-[#6143f4] dark:hover:bg-white/5 rounded-2xl transition-all">
            ...
            <div className="flex items-center gap-4 cursor-pointer group">
              <div className="text-right hidden xl:block">
                <p className="text-[10px] font-black text-[#13082A] dark:text-white uppercase tracking-widest leading-none mb-1 group-hover:text-[#6143f4] transition-colors italic">Dr. Aris Thorne</p>
                <p className="text-[9px] font-black text-[#009CDE] uppercase tracking-widest leading-none opacity-80">Chief Medical Admin</p>
              </div>
              <div className="relative size-12 transform group-hover:scale-105 transition-all duration-300">
                ...
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuDc06dRkQMPX1PaIHUwDmWNZdgnqpdeGR_Os5xbzp_-kK4LlKqU6T9KnhsGBbFcQ5fGSQefvg3DkK1rnAcaIOFe9bk8RKi7tTQ1fsGxCcsKyOVgzfpvaru51YCMOvIkfawPcHXmJ42a2iSwEik5E1hzc1wEjhPno1rVzJZohJIge9pxwvnGNnKpOAQmkN_fNJv2Qfvlx2y1010Rb7xddeyM0fSLobpZ-Ign2FuejCIgvIBVVQuhZQYPMivlvF16d_u146qyOVAK75UT" alt="Admin" className="size-full object-cover rounded-2xl border-2 border-white dark:border-white/10 shadow-lg relative z-10" />
              </div>
            </div>
          </div>
        </header>
