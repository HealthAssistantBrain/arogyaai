...
const EmailVerification = () => {
  ...
  // ── Verify Email: real API call to backend ───────────────────────────────
  const handleVerify = async () => {
    setIsVerifying(true);
    try {
      // Use the axios instance — it auto-attaches Authorization: Bearer <token>
      ...
      const detail = err.response?.data?.detail || err.message || 'Could not verify email.';
      toast.error(detail);
    } finally {
          ...
          <div className="p-8 md:p-12 flex flex-col items-center text-center">
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                {isVerifying ? 'Verifying...' : 'Verify My Email Account'}
              </button>
              <button
