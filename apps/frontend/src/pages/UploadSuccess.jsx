                ...
                <aside className="w-72 bg-white dark:bg-[#131022] border-r border-[#6143f4]/5 dark:border-white/5 flex flex-col h-full overflow-y-auto no-scrollbar hidden lg:flex shrink-0">
                    ...
                    <div className="p-6 border-t border-slate-100 dark:border-white/5">
                        <div className="bg-[#6143f4]/5 dark:bg-[#6143f4]/10 rounded-[2rem] p-6 border border-[#6143f4]/10 relative overflow-hidden group">
                                ...
                                <p className="text-[10px] text-slate-500 dark:text-slate-400 mb-4 font-bold uppercase tracking-widest leading-none">Status: Premium Active</p>
                                <button className="w-full py-3 bg-[#6143f4] text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-[#4a34c1] transition-all shadow-lg shadow-[#6143f4]/20 active:scale-95 leading-none">Manage Support</button>
                        </div>
                    </div>
                </aside>
