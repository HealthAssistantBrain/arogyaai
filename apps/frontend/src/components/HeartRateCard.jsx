...
const HeartRateCard = () => {
  ...
  return (
    <section className="rounded-[2rem] border border-slate-200/70 bg-white p-6 shadow-sm dark:border-stroke dark:bg-white/[0.03]">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h2 className="text-[24px] font-black tracking-tight text-text-primary dark:text-text-primary">
            Heart Rate
          </h2>
          <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-slate-500 dark:text-text-muted">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-3 text-[12px] font-black uppercase tracking-[0.16em] text-white transition hover:bg-[#5235dc]"
        >
          <RefreshCcw size={16} />
          Refresh
        </button>
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-[0.8fr_1.2fr]">
        <div className="rounded-[1.5rem] border border-slate-200/70 bg-slate-50/80 p-5 dark:border-stroke dark:bg-card">
          <p className="text-[11px] font-black uppercase tracking-[0.2em] text-text-muted">Latest BPM</p>
          <div className="mt-5 flex items-end gap-3">
            <span className="text-[48px] font-black leading-none tracking-tight text-text-primary dark:text-text-primary">
              {latestReading?.value ?? '--'}
            </span>
            <span className="mb-1 text-[13px] font-bold uppercase tracking-[0.18em] text-text-muted">BPM</span>
          </div>
          <div className="mt-6 flex items-center gap-3 rounded-2xl border border-white bg-white px-4 py-3 dark:border-stroke dark:bg-white/5">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-rose-500/10 text-rose-500">
              <Activity size={18} />
            </div>
            <div>
              <p className="text-[12px] font-black uppercase tracking-[0.16em] text-text-muted">Reading time</p>
              <p className="mt-1 text-[14px] font-semibold text-text-primary dark:text-text-primary">
        ...
        <div className="rounded-[1.5rem] border border-slate-200/70 bg-white p-5 dark:border-stroke dark:bg-card">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[0.2em] text-text-muted">Trend</p>
              <h3 className="mt-2 text-[20px] font-black tracking-tight text-text-primary dark:text-text-primary">
                Hourly heart rate
              </h3>
            </div>
            <span className="rounded-full bg-slate-100 px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-slate-500 dark:bg-white/5 dark:text-text-secondary">
              24h Window
            </span>
          </div>
          ...
          <div className="mt-5 min-h-[220px]">
            {loading ? (
              <div className="flex h-[220px] items-center justify-center rounded-2xl border border-dashed border-slate-200 text-[13px] font-semibold text-text-muted dark:border-stroke dark:text-slate-500">
              ...
              <>
                ...
                {todayData.length === 0 && (
                  <p className="mt-3 text-center text-[13px] font-semibold text-text-muted dark:text-slate-500">
                    {error || emptyMessage}
                  </p>
                )}
              </>
