...
const SettingsSkeleton = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-pulse">
        {/* Sidebar nav */}
        <div className="lg:col-span-1 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-6 space-y-3">
            {[1, 2, 3, 4, 5, 6].map(i => (
        ...
        {/* Content */}
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 p-8 space-y-8">
