      ...
      {isAssistantOpen ? null : (
        <div className="group relative">
          ...
          <div className="pointer-events-none absolute right-0 top-full hidden pt-3 lg:block">
            <div className="rounded-full border border-stroke bg-background px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.28em] text-text-primary opacity-0 shadow-lg shadow-black/20 transition-all duration-200 group-hover:opacity-100">
              AI Assistant
            </div>
          </div>
        </div>
