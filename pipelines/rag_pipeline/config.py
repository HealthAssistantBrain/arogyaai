...
class RagSettings:
    ...
    dense_top_k: int = field(default_factory=lambda: int(os.getenv("RAG_DENSE_TOP_K", "10")))
    sparse_top_k: int = field(default_factory=lambda: int(os.getenv("RAG_SPARSE_TOP_K", "10")))
    rerank_candidate_k: int = field(default_factory=lambda: int(os.getenv("RAG_RERANK_CANDIDATE_K", "10")))
    dense_weight: float = field(default_factory=lambda: float(os.getenv("RAG_DENSE_WEIGHT", "0.58")))
    sparse_weight: float = field(default_factory=lambda: float(os.getenv("RAG_SPARSE_WEIGHT", "0.42")))
